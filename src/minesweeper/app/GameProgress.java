...
public class GameProgress {
    ...
    public static void play(Scanner scanner, Game game) {
        ...
        while (gameCondition != 'v' && gameCondition != 'l') {
            ...
            switch (command) {
                case "d": { //dig
                    int x = getInt(scanner, "Where do you want to dig? Please type in the x-coordinate", 1, width) -1;
                    int y = getInt(scanner, "Where do you want to dig? Please type in the y-coordinate", 1, height) -1;
                    if (!(game.dig(x, y))) {
                ...
                case "f": { //flag
                    int x = getInt(scanner, "Where do you want to flag? Please type in the x-coordinate", 1, width) -1;
                    int y = getInt(scanner, "Where do you want to flag? Please type in the y-coordinate", 1, height) -1;
                    if (game.flag(x, y)) {
